...
export default function JoinRoomPage() {
  ...
  const isFormValid = formData.roomCode.length === 6 &&
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Room Code Input */}
            <div>
              <label htmlFor="roomCode" className="block text-white text-lg font-semibold mb-3 text-center">
          ...
          <div className="mt-8 bg-blue-500/20 border border-blue-400/30 rounded-xl p-4">
            <div className="text-sm text-blue-100">
              ...
              <p className='m-0'>รหัสห้องเป็นตัวเลข 6 หลักที่ได้รับจากผู้สร้างห้อง</p>
            </div>
          </div>
        </div>
      </div>
