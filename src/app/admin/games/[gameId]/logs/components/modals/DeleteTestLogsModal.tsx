interface DeleteTestLogsModalProps {
  isOpen: boolean;
...
export function DeleteTestLogsModal({
  isOpen,
  testLogsCount,
  isDeleting,
  onClose,
  onConfirm,
}: DeleteTestLogsModalProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6" style={{ animation: 'fadeIn 0.2s ease-out' }}>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-red-800">
            คุณกำลังจะลบ Log ทดสอบทั้งหมด <span className="font-bold">{testLogsCount} รายการ</span>
          </p>
