    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-6">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-blue-200">
              เปิดแล้ว {gameState.revealedNumbers.length}/
              {gameState.totalRounds} เลข
            </p>
          </div>
      ...
      {myAnswers.length > 0 &&
        (() => {
          const answersWithIndex =
            myAnswers as unknown as ItoPlayerAnswerWithIndex[];
          return (
      ...
      {gameState.phase === "writing" &&
        (() => {
          ...
          const playersNotCompleted = Object.entries(
            playerSubmissionStatus
          ).filter(([, p]) => p.submittedCount < p.totalExpected);
      ...
      {gameState.phase === "levelComplete" &&
        (() => {
          ...
          const handleReady = async () => {
            ...
            const success = await markPlayerReady(
              sessionId,
              playerId,
              playerName
            );
